            ...
            <div className="flex items-center gap-2">
              <button onClick={async () => {
                if (otherUser) {
                  ...
                  if (ok) {
                    useCallStore.getState().startCall(otherUser._id, otherUser.displayName || otherUser.username, otherUser.avatar?.url, 'audio')
                  }
                }
              ...
              <button onClick={async () => {
                if (otherUser) {
                  ...
                  if (ok) {
                    useCallStore.getState().startCall(otherUser._id, otherUser.displayName || otherUser.username, otherUser.avatar?.url, 'video')
                  }
                }
              }} className="p-2 text-white/80 hover:text-white hover:bg-white/10 rounded-full transition-all">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
